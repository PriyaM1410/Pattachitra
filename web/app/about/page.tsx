  ...
  return (
    <main className="about-page">
      ...
      <div className="about-header">
        ...
        <p>
          A life devoted to preserving Odisha&apos;s most sacred visual
          tradition.
        </p>
      </div>
      ...
      <section className="story">
        ...
        <div className="story-text">
          ...
          <p>
            Growing up in Raghurajpur — one of India&apos;s heritage craft
            villages — I watched my grandfather transform simple cotton cloth
            into vivid mythological worlds. The rhythm of his brush became my

...
export default function ArtDetailClient({
  ...
  const material = art.material === "Other" ? art.otherMaterial : art.material;
        ...
        <div className="art-grid">
          ...
          <section className="info-col">
            ...
            <div className="detail-card">
              ...
              {/* Time Taken */}
              {art.timeTaken && (
                <Row label="Time Taken" value={art.timeTaken} />
              )}
            ...
            {art.description && (
              <div className="desc-card">
                <span className="desc-title">About this piece</span>
            ...
            {!sold ? (
              ...
              <div className="sold-banner">
                This piece is currently unavailable — please check back within a
                week.
              </div>
            )}
          ...
          <section className="media-col">
            ...
            >
              ...
              <span className="zoom-hint">🔍 Tap to enlarge</span>
            </div>
        ...
        {relatedArts.length > 0 && (
          <section className="related">
            <div className="related-head">
              <span className="related-eyebrow">You may also like</span>
...
function Row({
  ...
  return (
    <div className="row">
      ...
      <span className={`row-value${state ? ` row-${state}` : ""}`}>
        {value}
      </span>
    </div>
  );

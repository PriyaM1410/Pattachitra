      ...
      <div className="footer-inner footer-grid">
        ...
        <div className="footer-brand">
          ...
          <div className="footer-socials">
            ...
            {/* Email - Opens Gmail in a new tab */}
            <a
        ...
        <div className="footer-rights">
          ...
          <p>
            All artworks on this website are original creations by the artist.
            We kindly request that you do not copy or use them without
            permission.
          </p>
        </div>
      </div>

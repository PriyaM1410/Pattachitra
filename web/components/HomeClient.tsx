    ...
    <main className="home">
      ...
      <section className="artist">
        ...
        <div className="artist-text">
          ...
          <p>
            As a practitioner of this sacred art, I dedicate each brushstroke to
            preserving our cultural heritage while sharing it with the modern
      ...
      {/* SELECTED WORKS — now dynamic, fetched from Sanity via page.tsx */}
